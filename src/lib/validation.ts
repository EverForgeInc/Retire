...
export const profileUpdateSchema = z.object({
  ...
  intendedPostServiceCountry: z.string().optional(),
  moving: z.boolean().optional(),
  spouse: z.boolean().optional(),
  dependents: z.coerce.number().int().min(0).max(20).optional(),
  skillbridgeIntent: z.enum(["yes", "no", "maybe", "not_yet"]).optional(),
  skillbridgeStart: dateString.nullable().optional(),
  skillbridgeEnd: dateString.nullable().optional(),
  vaClaimIntent: z.enum(["yes", "no", "maybe", "not_yet"]).optional(),
  vaHealthCareIntent: z.enum(["yes", "no", "maybe", "not_yet"]).optional(),
  civilianEmployment: z.enum(["employed", "planning", "seeking", "none", "not_yet"]).optional(),
  federalEmployment: z.enum(["yes", "no", "considering", "not_yet"]).optional(),
  ceremony: z.enum(["yes", "no", "maybe", "not_yet"]).optional(),
